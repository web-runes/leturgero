...
- made astro fonts, similar to next.js and nuxt (link to comparison?)
- wanted a way to allow all frameworks to use it
- a different take on the fonts problem
- you own the files so you can do anything (one drawback of packages is they abstract a bit too much)
- privacy using self hosting
- do it once
- optimized: guides, automatic fallback generation (upcoming)
